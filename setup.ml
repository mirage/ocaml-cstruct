       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_bounds", []))];
          ...
          ("test_ppx_pcap",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ppx_pcap", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_ppx_basic",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ppx_basic", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_ppx_enum",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ppx_enum", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("misc_tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$misc_tests", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the ppx syntax extension";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
               ...
               Object
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ocaml-migrate-parsetree", None);
                           FindlibPackage ("ppx_tools_versioned", None);
                           FindlibPackage
                             ("ppx_tools_versioned.metaquot_404", None);
                           FindlibPackage ("bigarray", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      obj_modules = ["Ppx_cstruct"];
                      obj_findlib_fullname = Some ["cstruct"; "ignore"];
                      obj_findlib_directory = None
                   });
               Executable
                 ({
                     cs_name = "ppx_cstruct";
                   ...
                   {exec_custom = true; exec_main_is = "standalone.ml"});
               Executable
                 ({
                     cs_name = "test_bounds";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "bounds.ml"});
               Test
                 ({
                     cs_name = "test_bounds";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "_build/lib/";
                      test_run =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "ppx_cstruct"
                        ];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = true; exec_main_is = "basic.ml"});
               Executable
                 ({
                     cs_name = "test_ppx_enum";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "enum.ml"});
               Executable
                 ({
                     cs_name = "test_ppx_pcap";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "pcap.ml"});
               Test
                 ({
                     cs_name = "test_ppx_pcap";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "ppx_test";
                      test_run =
                        [
                           (OASISExpr.ENot (OASISExpr.EFlag "tests"), false);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "tests.ml"});
               Test
                 ({
                     cs_name = "misc_tests";
                     cs_data = PropList.Data.create ();
