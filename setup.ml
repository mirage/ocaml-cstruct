...
(* OASIS_START *)
(* DO NOT EDIT (digest: da8e93cba1015dab5bb746b993c0096c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "ppx_cstruct.ml"});
               Executable
                 ({
                     cs_name = "test_bounds";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\233\161'\137\227\186,W\005\210i\152\162WG\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
