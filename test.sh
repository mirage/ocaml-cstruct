...
test() {
if [ -f _build/syntax/cstruct-syntax.cma ]; then
  echo $1
...
cp lib_test/$1.ml _build/lib_test/$1.ml
cd _build/lib_test
ocamlopt -o $1.opt -I ../lib -I ../unix $pkgs $sexplibi cstruct.cmxa $1.ml -linkall
time ./$1.opt
cd ../..
}
